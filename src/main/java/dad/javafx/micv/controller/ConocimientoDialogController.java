...
public class ConocimientoDialogController extends Dialog<Conocimiento> implements Initializable {
	...
	public ConocimientoDialogController() {
		...
		getDialogPane().setContent(loadContent("/fxml/ConocimientoDialog.fxml"));
